...
export default function KotaKeberangkatanPage() {
  ...
  const fetchCities = async () => {
    setLoading(true);
    try {
      const res = await fetch(`${BASE_URL}/master/kotaKeberangkatan`);
  ...
  const handleSubmit = async () => {
    ...
    const endpoint = isEdit
      ? `${BASE_URL}/master/editKotaKeberangkatan`
      : `${BASE_URL}/master/buatKotaKeberangkatan`;
  ...
  return (
    <div className="p-6 space-y-4">
      ...
      <div className="flex justify-between items-center">
        <h1 className="text-xl font-bold">Master Kota Keberangkatan</h1>
        <button
          onClick={() => {
            setIsEdit(false);
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white w-[400px] p-6 rounded max-h-[90vh] overflow-y-auto">
